# Generated by Django 4.1.7 on 2023-06-16 10:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments_as_hospital', to='user.hospital')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments_as_patient', to='user.patient')),
            ],
        ),
        migrations.CreateModel(
